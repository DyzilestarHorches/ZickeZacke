 ...
 *
 * @author Xoppa */
public class Animation3D extends BaseAnimationController {
     ...
     * @param target The {@link Instance3D} on which the animations will be performed. */
    public Animation3D (final Instance3D target) {
        super(target);
    }
