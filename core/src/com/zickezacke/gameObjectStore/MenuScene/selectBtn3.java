...
public class selectBtn3 extends Btn{
    private static boolean isChoose;
    public selectBtn3(int id, String type){super(id,type);}

    @Override
    public void objectInit() {
        super.objectInit();
        position2D = new Vector2((float)6.5*cellWidth, (float)3.5 * cellHeight);
