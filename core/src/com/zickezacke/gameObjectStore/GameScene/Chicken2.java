...
public class Chicken2 extends GameObject3D {
    private boolean isMoving;
    private BoundingVisual boundingVisual = new BoundingVisual();
    public Chicken2(int id){super(id, true);}

    @java.lang.Override
    public void objectInit() {
        source3D = "demo.g3db";
        position3D = new Vector3(0,0,2);
    ...
    public void objectUpdate() {
        isActive = selectBtn2.getState();
        boundingVisual.drawBox(dimensions,bounds, Color.GREEN);
        animation();
    }
